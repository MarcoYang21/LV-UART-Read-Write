...
<Project Type="Project" LVVersion="20008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="actor" Type="Folder">
			<Item Name="UART Actor.lvlib" Type="Library" URL="../actor/UART Actor/UART Actor.lvlib"/>
		</Item>
		<Item Name="Libraries" Type="Folder">
			<Item Name="UART Module.lvlib" Type="Library" URL="../Libraries/UART Module/UART Module.lvlib"/>
		</Item>
		<Item Name="Test API" Type="Folder">
			<Item Name="Test UART Module API.vi" Type="VI" URL="../Libraries/UART Module/Test UART Module API.vi"/>
		</Item>
		<Item Name="workers" Type="Folder">
			<Item Name="UART Worker.lvclass" Type="LVClass" URL="../Workers/UART Worker/UART Worker.lvclass"/>
		</Item>
		<Item Name="Launcher - UART Worker.vi" Type="VI" URL="../Launchers/Launcher - UART Worker.vi"/>
		<Item Name="Read Write Sample Code - JKI SM.vi" Type="VI" URL="../Read Write Sample Code - JKI SM.vi"/>
		<Item Name="Read Write Sample Code AF Launcher.vi" Type="VI" URL="../Read Write Sample Code AF Launcher.vi"/>
		<Item Name="Read Write Sample Code.vi" Type="VI" URL="../Read Write Sample Code.vi"/>
